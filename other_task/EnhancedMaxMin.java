...
public class EnhancedMaxMin {
	...
	public static void main(String[] args) {
	     ...
	     */
	    private static void PrintCloudlets() {
		...
		Log.printLine("Cloudlet ID" + indent + "STATUS" + indent +
				"Data center ID" + indent + "VM ID" + indent + "Time" + indent + "Start Time" + indent + "Finish Time"+indent+"cpu usage"+indent+ indent+"ram usage");
			...
			if (cloudlet.getCloudletStatus() == Cloudlet.SUCCESS){
				...
				Log.printLine( indent + indent + cloudlet.getResourceId() + indent + indent + indent + cloudlet.getVmId() +
						...
						indent + indent + dft.format(cloudlet.getFinishTime())+indent+indent+ cloudlet.getUtilizationOfCpu(cloudlet.getFinishTime())*100+
                                                indent+indent+ cloudlet.getUtilizationOfRam(cloudlet.getFinishTime())*100);
